...
const Untitled8 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.LshcpMHQ}></View><Text style={styles.CfKBHJpx}>Lorem ipsum…</Text><ActivityIndicator style={styles.BLeiZaHm}></ActivityIndicator></ScrollView>
    <CheckBox style={styles.ngCSYoEf} title="Checkbox Title"></CheckBox><Slider style={styles.MjWwRKwo} thumbStyle={{
      height: 20,
      width: 20
    }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><Switch style={styles.mqExUacQ}></Switch><ImageBackground style={styles.KQLmNMsg} source={{

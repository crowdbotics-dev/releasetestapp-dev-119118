...
## Project Structure
    ...
    ├── releasetestapp_dev_119118  # Django project configurations
...
1. Clone this repo and `cd releasetestapp_dev_119118`
...
2. Clone this repo and `cd releasetestapp_dev_119118`
